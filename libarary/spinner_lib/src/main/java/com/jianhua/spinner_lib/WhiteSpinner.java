...
package com.jianhua.spinner_lib;
 ...
 */
public class WhiteSpinner extends android.support.v7.widget.AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         */
        if (!hideArrow) {
            arrowDrawable = ContextCompat.getDrawable(context, R.drawable.black_arrow).mutate();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onItemSelectedListener != null) {
                    ...
                    onItemSelectedListener.onItemSelected(WhiteSpinner.this, position, id, item);
                }
            }
        });
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(WhiteSpinner.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
    ...
    public interface OnItemSelectedListener<T> {
         ...
         * item.</p>
         *
         * @param view     The {@link WhiteSpinner} view
         * @param position The position of the view in the adapter
         * @param id       The row id of the item that is selected
         * @param item     The selected item
         */
        void onItemSelected(WhiteSpinner view, int position, long id, T item);
    }
    ...
    public interface OnNothingSelectedListener {
         ...
         *
         * @param spinner the {@link WhiteSpinner}
         */
        void onNothingSelected(WhiteSpinner spinner);
    }
